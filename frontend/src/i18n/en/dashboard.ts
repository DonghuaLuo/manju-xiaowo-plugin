export default {
  ...
  quality_stats_average: "Average {{score}}",
  quality_stats_final_average: "Refined avg {{score}}",
  quality_stats_sample_count: "All versions {{count}}",
  quality_stats_dimension_average: "All versions {{key}} {{score}}",
