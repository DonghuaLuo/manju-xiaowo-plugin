export default {
  ...
  jianying_export_completed_partial: "Jianying draft created, exported {{exported}} videos and skipped {{missing}} ungenerated shots",
  jianying_export_missing_items: "Ungenerated shots: {{items}}",
  ...
  asset_export_description: "Export the global asset library, custom style favorites, and splitting templates. Export projects one by one from each project.",
  ...
  asset_export_script_splitting_templates: "Export splitting templates",
  asset_export_script_splitting_templates_hint: "Includes custom saved script splitting templates",
  ...
  generate_jianying_zip_hint: "Export only generated videos; ungenerated shots are skipped with a warning",
  ...
  generation_profile_grid: "Grid storyboard board",
  generation_profile_video_draft: "Fast video",
  generation_profile_video_final: "Refined video",
  generation_profile_reference_video_draft: "Fast reference video",
  generation_profile_reference_video_final: "Refined reference video",
  generation_profile_duration_project_default: "Follow project duration",
  ...
  mode_storyboard: "Image-to-Video (Recommended)",
  mode_grid: "Grid Fast Storyboards",
  mode_reference_video: "Reference Video Preview",
  mode_storyboard_desc: "Recommended production flow: generate storyboards first, then per-shot videos. Start/end-frame models can bridge to the next storyboard.",
  mode_grid_desc: "Quickly batch fast grid storyboards to check style and rhythm; most shots can ship from fast clips, while important shots can be refined manually.",
  mode_reference_video_desc: "Skip storyboards and generate clips directly from character/scene/prop references. Best for quick previews and mood tests.",
  video_service_tier_label: "Service tier",
  service_tier_default: "Default",
  service_tier_default_desc: "Standard scheduling. Generation quality is unchanged; speed and cost follow the provider default.",
  service_tier_flex: "Flex",
  service_tier_flex_desc: "Flexible scheduling. Generation quality is unchanged; speed is lower and cost is reduced.",
  service_tier_unsupported_desc: "The current video model does not support this tier.",
  service_tier_unsupported_hint: "Unavailable",
  video_continuity_policy_label: "Video continuity strategy",
  video_continuity_policy_auto: "Auto",
  ...
  media_video_continuity_actual: "Actual",
  media_video_continuity_expected: "Expected",
  media_video_continuity_start_only: "start-only",
  media_video_continuity_end_frame: "start/end frames",
  media_video_continuity_reference_assisted: "reference-assisted",
  transition_to_next_label: "Transition",
  transition_cut: "Cut",
  transition_fade: "Fade",
  transition_dissolve: "Dissolve",
  transition_cut_hint: "Best for continuous shots in the same scene; preserves the chance to use start/end frames.",
  transition_fade_hint: "Best for scene or time jumps; video generation falls back to start-frame only.",
  transition_dissolve_hint: "Best for soft or memory-like transitions; video generation falls back to start-frame only.",
  ...
  reference_preview_generate_draft: "Generate fast version",
  reference_preview_generate_final: "Generate refined version",
  reference_preview_regenerate_draft: "Regenerate fast version",
  reference_preview_regenerate_final: "Regenerate refined version",
  ...
  segment_refs_group_character: "Character set",
  segment_refs_group_scene: "Scene set",
  segment_refs_group_prop: "Prop set",
  segment_refs_search_group_placeholder: "Search {{group}}…",
  segment_refs_search_group_aria: "Search {{group}}",
  ...
  segment_refs_missing_script_file: "Missing script file. Refresh the project before checking reference image limits.",
  segment_refs_missing_script_file_for_update: "Missing script file. Refresh the project before updating references.",
  segment_refs_remove_reference_aria: "Remove {{name}} from this shot",
  segment_refs_remove_confirm_title: "Remove reference",
  segment_refs_remove_confirm_desc: "Remove {{kind}} \"{{name}}\" from this shot only? The source asset image will stay in the library.",
  segment_refs_remove_confirm: "Remove",
  segment_refs_removing: "Removing...",
  segment_refs_remove_failed: "Failed to remove reference: {{message}}",
  ...
  generate_all_grids: "Generate grid boards",
  ...
  dialogue_emotion_placeholder: "Emotion / delivery",
  dialogue_position: "Screen position",
  dialogue_position_unspecified: "Position",
  dialogue_position_left: "Left",
  dialogue_position_center: "Center",
  dialogue_position_right: "Right",
  dialogue_position_offscreen: "Offscreen",
  ...
  grid_preview_summary: "{{batches}} batches · {{cells}} shots · {{percent}}% ready",
  ...
  grid_preview_single_card_title: "Batch #{{index}} · single storyboard",
  ...
  tool_name_source_info: "Inspect source stats",
  tool_name_peek_split_point: "Preview episode split",
  tool_name_split_episode: "Split episode source",
  tool_name_reset_episode_artifacts: "Reset episode artifacts",
  ...
  media_generate_storyboard_draft: "Generate fast version",
  media_regenerate_storyboard_draft: "Regenerate fast version",
  media_generate_storyboard_final: "Refined",
  media_storyboard_final_mode_menu: "Choose refined storyboard mode",
  media_storyboard_final_mode_draft_locked: "Refine current storyboard",
  media_storyboard_final_mode_draft_locked_desc: "Keep the current composition, character positions, and shot relationships for a stable refined storyboard.",
  media_storyboard_final_mode_fresh_sample: "Fresh image",
  media_storyboard_final_mode_fresh_sample_desc: "Do not lock the current storyboard; redraw from the prompt plus character, scene, and prop references.",
  media_generate_video: "Generate video",
  media_regenerate_video: "Regenerate video",
  media_generate_video_draft: "Generate fast version",
  media_regenerate_video_draft: "Regenerate fast version",
  media_generate_video_final: "Refined",
  quality_stats_average: "Quality avg {{score}}/5",
  quality_stats_final_average: "Refined quality avg {{score}}/5",
  quality_stats_sample_count: "Rated versions {{count}}",
  quality_stats_dimension_average: "{{key}} {{score}}/5",
  quality_dimension_character_consistency: "Character consistency",
  quality_dimension_composition: "Composition",
  quality_dimension_motion_naturalness: "Motion naturalness",
  quality_dimension_prompt_faithfulness: "Prompt match",
