export default {
  ...
  generation_profile_storyboard_draft: "Draft storyboard",
  generation_profile_storyboard_final: "Final storyboard",
  generation_profile_grid: "Grid storyboard board",
  generation_profile_video_draft: "Draft video",
  generation_profile_video_final: "Final video",
  generation_profile_reference_video_draft: "Draft reference video",
  generation_profile_reference_video_final: "Final reference video",
  ...
  mode_grid: "Grid Storyboard Draft",
  mode_reference_video: "Reference Video Preview",
  mode_storyboard_desc: "Recommended for final output: generate storyboards first, then per-shot videos. Start/end-frame models can bridge to the next storyboard.",
  mode_grid_desc: "Quickly batch grid storyboard drafts to check style and rhythm; final videos should still return to per-shot generation.",
  mode_reference_video_desc: "Skip storyboards and generate clips directly from character/scene/prop references. Best for previews and mood drafts.",
  ...
  reference_preview_generate_draft: "Generate draft",
  reference_preview_generate_final: "Generate final",
  reference_preview_regenerate_draft: "Regenerate draft",
  reference_preview_regenerate_final: "Regenerate final",
  ...
  media_generate_storyboard_draft: "Generate draft storyboard",
  media_regenerate_storyboard_draft: "Regenerate draft storyboard",
  media_generate_storyboard_final: "Final",
  media_storyboard_final_mode_menu: "Choose final storyboard mode",
  media_storyboard_final_mode_draft_locked: "Refine current storyboard",
  media_storyboard_final_mode_draft_locked_desc: "Keep the current composition, character positions, and shot relationships for a stable final storyboard.",
  ...
  media_generate_video_draft: "Generate draft video",
  media_regenerate_video_draft: "Regenerate draft video",
  media_generate_video_final: "Final",
  quality_stats_average: "Average {{score}}",
  quality_stats_final_average: "Final avg {{score}}",
