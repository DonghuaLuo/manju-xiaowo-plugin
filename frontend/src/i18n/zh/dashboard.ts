...
export default {
  ...
  finalize_episode: "最终化本集",
  finalizing_episode: "最终化中...",
  finalize_episode_started: "最终化任务已提交：{{count}} 个任务",
  finalize_episode_noop: "本集已是最终状态",
  finalize_episode_has_issues: "最终化有 {{count}} 个项目需要处理",
  finalize_episode_failed: "最终化本集失败: {{message}}",
  ...
  generate_jianying_zip_hint: "直接在剪映草稿目录中创建草稿",
  select_episode: "选择集数",
  ...
  generation_profile_storyboard_draft: "分镜草稿",
  generation_profile_storyboard_final: "分镜最终版",
  generation_profile_grid: "宫格镜头板",
  generation_profile_video_draft: "视频草稿",
  generation_profile_video_final: "视频最终版",
  generation_profile_reference_video_draft: "参考视频草稿",
  generation_profile_reference_video_final: "参考视频最终版",
  ...
  mode_grid_desc: "快速批量生成宫格分镜草稿，适合先看整体画风和节奏；最终视频仍建议回到逐镜头生成。",
  mode_reference_video_desc: "跳过分镜，用角色/场景/道具参考图直接生成片段，适合快速预览和氛围草稿。",
  ...
  reference_preview_generate_final: "生成最终版",
  reference_preview_regenerate_draft: "重生成草稿",
  reference_preview_regenerate_final: "重生成最终版",
  ...
  media_generate_storyboard_final: "最终版",
  media_storyboard_final_mode_menu: "选择最终版生成方式",
  media_storyboard_final_mode_draft_locked: "沿当前分镜精修",
  media_storyboard_final_mode_draft_locked_desc: "保留当前分镜构图、角色位置和镜头关系，适合稳定出正式分镜。",
  ...
  media_generate_video_final: "最终版",
  quality_stats_average: "平均 {{score}}",
  quality_stats_final_average: "最终版平均 {{score}}",
