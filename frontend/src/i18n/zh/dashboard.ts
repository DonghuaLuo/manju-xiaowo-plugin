...
export default {
  ...
  asset_export_description: "导出全局资产库与自定义风格收藏。项目本体请继续使用每个项目的单独导出。",
  ...
  mode_storyboard: "图生视频（推荐）",
  mode_grid: "宫格分镜快速版",
  mode_reference_video: "参考视频预览",
  mode_storyboard_desc: "推荐正式成片：先生成分镜图，再逐镜头图生视频；支持首尾帧的模型会自动衔接下一张分镜。",
  mode_grid_desc: "快速批量生成宫格分镜快速版，适合先看整体画风和节奏；大部分镜头可直接出片，重要镜头再手动精修。",
  ...
  endpoint_dashscope_image_display: "阿里百炼（图像）",
