...
export default {
  ...
  model_config_project_desc: "为此项目选择默认模型和基础规格；实际生成规格以生成质量策略为准，留空则跟随全局默认",
  generation_profiles_section_title: "生成质量策略",
  generation_profiles_section_desc: "控制各类任务实际使用的模型、分辨率、音频和连续性策略；上方模型配置主要用于初始化与兜底。",
