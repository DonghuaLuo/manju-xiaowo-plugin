...
export default {
  ...
  import_success: "导入成功",
  import_failed: "导入失败",
  asset_import_success: "资产导入完成：{{assets}} 条资产元数据，{{files}} 个文件",
  asset_import_success_with_config: "资产导入完成：{{assets}} 条资产元数据，{{files}} 个文件，并已导入全局配置",
  ...
  style_favorite_saved: "已收藏到风格收藏",
  style_favorite_failed: "收藏风格失败: {{message}}",
  style_favorite_invalid: "请先上传风格参考图并填写风格提示词",
  style_clear: "清空风格",
  ...
  click_to_select_files: "或点击选择源文件",
  ...
  jianying_export_started: "剪映草稿导出任务已开始",
  jianying_export_completed: "剪映草稿已创建",
  jianying_export_completed_partial: "剪映草稿已创建，已导出 {{exported}} 个视频，跳过 {{missing}} 个未生成镜头",
  jianying_export_missing_items: "未生成镜头：{{items}}",
  jianying_export_failed: "剪映草稿导出失败: {{message}}",
  finalize_episode: "检查本集视频完整性",
  finalizing_episode: "检查中...",
  finalize_episode_started: "本集检查完成：{{count}} 项",
  finalize_episode_noop: "本集视频已完整，可合并片段",
  finalize_episode_has_issues: "本集有 {{count}} 项需要处理",
  finalize_episode_failed: "检查本集失败: {{message}}",
  project_zip_export_started: "项目 ZIP 导出任务已开始",
  project_zip_export_completed_with_diagnostics: "项目 ZIP 导出完成，导出包包含 {{count}} 条诊断",
  project_zip_export_completed: "项目 ZIP 导出完成",
  asset_export_started: "资产导出任务已开始",
  asset_export_completed: "资产导出完成",
  asset_export_failed: "资产导出失败: {{message}}",
  asset_export_info_failed: "读取资产导出信息失败: {{message}}",
  asset_export_save_title: "导出资产 ZIP",
  asset_export_title: "导出资产",
  asset_export_description: "导出全局资产库、自定义风格收藏与拆分模板。项目本体请继续使用每个项目的单独导出。",
  asset_export_assets_label: "导出内容",
  asset_export_character_library: "角色库",
  asset_export_character_library_hint: "包含角色资产元数据和全局角色图片",
  asset_export_scene_library: "场景库",
  asset_export_scene_library_hint: "包含场景资产元数据和全局场景图片",
  asset_export_prop_library: "道具库",
  asset_export_prop_library_hint: "包含道具资产元数据和全局道具图片",
  asset_export_style_favorites: "自定义风格收藏",
  asset_export_style_favorites_hint: "包含收藏的风格模板和缩略图",
  asset_export_script_splitting_templates: "导出拆分模板",
  asset_export_script_splitting_templates_hint: "包含自定义保存的拆分方案模板",
  asset_export_global_config: "同时导出全局配置",
  asset_export_global_config_hint: "包含智能体、供应商 API、自定义供应商、模型默认值等配置。",
  asset_export_global_config_warning: "全局配置包含 API Key 等敏感信息，请只保存到可信位置。",
  asset_export_projects_root_label: "所有项目目录",
  asset_export_projects_root_loading: "正在读取项目目录...",
  asset_export_projects_root_unavailable: "暂时无法读取项目目录",
  asset_export_projects_root_hint: "不提供全部项目导出，避免 ZIP 过大。需要迁移项目时，可打开此目录后手动复制项目文件夹。",
  open_projects_root_failed: "无法打开项目目录：{{message}}",
  export_failed: "导出失败: {{message}}",
  open_saved_file_title: "打开保存位置？",
  open_saved_file_prompt: "已保存到：\n{{path}}\n\n是否现在打开所在目录？",
  open_saved_file_failed: "无法打开保存位置：{{message}}",
  ...
  generate_jianying_zip_hint: "只导出已出片视频，未生成镜头会提示并跳过",
  select_episode: "选择集数",
  ...
  draft_path_hint: "请选择剪映草稿目录。导出后打开剪映会自动加载新草稿。",
  select_draft_dir: "选择草稿目录",
  exporting: "导出中...",
  export_draft: "导出草稿",
  ...
  model_config_project_desc: "为此项目选择默认模型和基础规格；项目没有单独设置时，会自动使用这里的默认值。",
  generation_profiles_section_title: "生成默认设置",
  generation_profiles_section_desc: "设置项目级默认分辨率。单个分镜和单个视频后续仍可单独覆盖模型、分辨率和连续性。",
  generation_profile_asset: "角色 / 场景 / 道具母版",
  generation_profile_storyboard_draft: "分镜快速版",
  generation_profile_storyboard_final: "分镜精修版",
  generation_profile_grid: "宫格镜头板",
  generation_profile_video_draft: "视频快速版",
  generation_profile_video_final: "视频精修版",
  generation_profile_reference_video_draft: "参考视频快速版",
  generation_profile_reference_video_final: "参考视频精修版",
  generation_profile_duration_project_default: "跟随项目时长",
  episode_planning_section_title: "分集规划",
  source_language_label: "源语言",
  source_language_zh: "中文",
  source_language_en: "英文",
  source_language_vi: "越南语",
  episode_target_units_label: "每集目标长度",
  episode_target_units_hint: "中文按字符计数，英文/越南语按词数计数",
  aspect_ratio_label: "画面比例",
  aspect_ratio_change_warning: "已生成的分镜图/视频仍为原比例，建议重新生成",
  generation_mode: "分镜生成模式",
  mode_storyboard: "图生视频",
  mode_grid: "宫格分镜",
  mode_reference_video: "参考视频",
  mode_storyboard_desc: "推荐正式成片：先生成分镜图，再逐镜头图生视频；支持首尾帧的模型会自动衔接下一张分镜。",
  mode_grid_desc: "快速批量生成宫格分镜，适合先看整体画风和节奏；大部分镜头可直接出片，重要镜头再手动精修。",
  mode_reference_video_desc: "跳过分镜，用角色/场景/道具参考图直接生成片段，适合快速预览和氛围测试。",
  video_service_tier_label: "服务档位",
  service_tier_default: "默认",
  service_tier_default_desc: "标准调度，生成质量不变，速度和费用按供应商默认。",
  service_tier_flex: "Flex",
  service_tier_flex_desc: "弹性调度，生成质量不变，速度降低，费用减少。",
  service_tier_unsupported_desc: "当前视频模型不支持此档位。",
  service_tier_unsupported_hint: "不可选",
  video_continuity_policy_label: "视频连续性策略",
  video_continuity_policy_auto: "自动选择",
  ...
  media_video_continuity_actual: "实际",
  media_video_continuity_expected: "预计",
  media_video_continuity_start_only: "仅首帧",
  media_video_continuity_end_frame: "首尾帧衔接",
  media_video_continuity_reference_assisted: "参考图辅助",
  transition_to_next_label: "转场",
  transition_cut: "硬切",
  transition_fade: "淡入淡出",
  transition_dissolve: "溶解",
  transition_cut_hint: "适合同一场景内的连续镜头，会优先保留首尾帧衔接机会。",
  transition_fade_hint: "适合跨场景或时间跳转，会让视频生成回退为仅首帧。",
  transition_dissolve_hint: "适合柔和过渡或回忆感镜头，会让视频生成回退为仅首帧。",
  ...
  image_safety_blocked_summary: "图片生成被安全系统拦截（{{violations}}）。请柔化暴力、血腥、伤害、武器或惊悚攻击等视觉描述后重试。请求 ID：{{requestId}}",
  image_safety_blocked_unknown_violation: "安全策略",
  image_safety_blocked_no_request_id: "无",
  ...
  segment_refs_group_scene: "场景集",
  segment_refs_group_prop: "道具集",
  segment_refs_search_group_placeholder: "搜索{{group}}…",
  segment_refs_search_group_aria: "搜索{{group}}",
  ...
  segment_refs_missing_script_file: "缺少剧本文件，无法检查参考图上限，请刷新项目后重试。",
  segment_refs_missing_script_file_for_update: "缺少剧本文件，无法更新引用，请刷新项目后重试。",
  segment_refs_remove_reference_aria: "从当前分镜移除 {{name}} 引用",
  segment_refs_remove_confirm_title: "移除引用",
  segment_refs_remove_confirm_desc: "确定只从当前分镜移除{{kind}}「{{name}}」的引用吗？素材图片本身不会被删除。",
  segment_refs_remove_confirm: "移除",
  segment_refs_removing: "移除中...",
  segment_refs_remove_failed: "移除引用失败：{{message}}",
  ...
  line_placeholder: "台词",
  dialogue_emotion_placeholder: "情绪 / 语气",
  dialogue_position: "画面位置",
  dialogue_position_unspecified: "位置",
  dialogue_position_left: "左侧",
  dialogue_position_center: "中间",
  dialogue_position_right: "右侧",
  dialogue_position_offscreen: "画外",
  add_dialogue: "添加对话",
  ...
  delete_design: "删除设计图",
  confirm_delete_design_title: "删除设计图",
  confirm_delete_design_desc: "确定删除「{{name}}」及其全部版本文件吗？此操作不可撤销。",
  deleting_design: "删除中...",
  design_deleted: "已删除 {{name}}",
  design_delete_in_use: "已应用，无法删除",
  design_delete_failed: "删除设计图失败: {{message}}",
  delete_version: "删除版本",
  confirm_delete_version_title: "删除版本",
  confirm_delete_version_desc: "确定删除历史版本 v{{version}} 吗？此操作不可撤销。",
  deleting_version: "删除中...",
  version_deleted: "已删除 v{{version}}",
  version_delete_current_blocked: "当前版本正在应用，无法删除。",
  version_delete_last_blocked: "必须保留至少一个版本。",
  version_delete_failed: "删除版本失败: {{message}}",
  delete_files_partial_failed: "已删除记录，但有 {{count}} 个文件未成功删除。",
  delete_project: "删除项目",
  ...
  batch_generate_storyboards_confirm_desc: "即将为 {{count}} 个分镜提交分镜图生成任务，确定继续吗？",
  batch_generate_videos: "批量生成视频",
  batch_generate_videos_confirm_desc: "即将为 {{count}} 个分镜提交视频生成任务，确定继续吗？",
  generate_all_grids_confirm_desc: "即将为当前分集提交全部宫格镜头板生成任务，确定继续吗？",
  grid_preview_batch_generate_confirm_desc:
    "即将为这一组 {{count}} 个分镜提交宫格镜头板生成任务，确定继续吗？",
  reference_batch_generate_confirm_desc: "即将为 {{count}} 个 Unit 提交视频生成任务，确定继续吗？",
  ...
  tool_name_source_info: "统计源文件",
  tool_name_peek_split_point: "预览分集切点",
  tool_name_split_episode: "切分单集",
  tool_name_reset_episode_artifacts: "重置单集产物",
  ...
  media_storyboard_final_mode_menu: "选择精修版生成方式",
  media_storyboard_final_mode_draft_locked: "沿当前分镜精修",
  media_storyboard_final_mode_draft_locked_desc: "保留当前分镜构图、角色位置和镜头关系，适合稳定出精修分镜。",
  media_storyboard_final_mode_fresh_sample: "重新出图",
  media_storyboard_final_mode_fresh_sample_desc: "不锁定当前分镜，只按提示词与角色、场景、道具参考重新抽一张。",
  ...
  quality_stats_average: "质量平均 {{score}}/5",
  quality_stats_final_average: "精修版质量平均 {{score}}/5",
  quality_stats_sample_count: "已评分 {{count}} 个版本",
  quality_stats_dimension_average: "{{key}} {{score}}/5",
  quality_dimension_character_consistency: "角色一致性",
  quality_dimension_composition: "构图质量",
  quality_dimension_motion_naturalness: "动作自然度",
  quality_dimension_prompt_faithfulness: "提示词贴合度",
  ...
  lobby_hero_greeting_morning: "欢迎回来，导演。",
  lobby_hero_greeting_afternoon: "欢迎回来，导演。",
  lobby_hero_greeting_evening: "欢迎回来，导演。",
  lobby_hero_greeting_late: "欢迎回来，导演。",
  lobby_hero_subtitle_active: "{{count}} 部作品正在制作中。",
  lobby_hero_subtitle_quiet: "当前没有作品在制作中。",
  ...
  lobby_hero_tutorial_label: "视频教程：快速上手演示",
  lobby_stat_total: "项目",
