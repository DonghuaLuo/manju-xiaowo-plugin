...
export default {
  ...
  batch_add_to_library: "批量加入资产库",
  batch_add_to_library_description: "只会把 {{title}} 中已生成设计图且尚未加入资产库的条目加入资产库。",
  batch_add_to_library_checking: "正在检查哪些设计图可以加入资产库...",
  batch_add_to_library_ready: "可加入资产库",
  batch_add_to_library_missing_design: "未生成设计图",
  batch_add_to_library_existing: "资产库已有",
  batch_add_to_library_none: "暂无",
  batch_add_to_library_summary: "符合条件 {{count}} / {{total}}",
  confirm_batch_add_to_library: "确认批量加入",
  batch_add_to_library_success_count: "已加入资产库 {{count}} 个",
  batch_add_to_library_failed_count: "{{count}} 个条目加入资产库失败",
