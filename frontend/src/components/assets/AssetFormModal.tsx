...
export function AssetFormModal({
  ...
  const [image, setImage] = useState<UploadFileInput | null>(null);
  ...
  useEffect(() => {
    ...
    if (isDesktopFileRef(image)) {
      setLocalPreview(image.previewUrl ?? null);
      return;
    }
