...
| **火山方舟** | Seedance 2.0, Seedance 2.0 Fast, Seedance 1.5 Pro, Seedance 1.0 Pro, Seedance 1.0 Pro Fast, Seedance 1.0 Lite I2V | 文生视频、图生视频、视频延展、音频生成、种子控制、离线推理（按模型不同） | 2–15（按模型不同） | 按 token 用量 (CNY) |
...
| **视频生成** | Gemini Veo 3.1 (`google-genai`), 火山方舟 Seedance 2.0/1.5/1.0 (`volcengine-python-sdk[ark]`), Grok (`xai-sdk`), OpenAI Sora 2 (`openai`), Vidu Q3 (`httpx`) |
