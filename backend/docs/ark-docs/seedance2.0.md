...
| **能力项**              | **Seedance 2.0**             | **Seedance 2.0 fast**             | **Seedance 1.5 pro**             | **Seedance 1.0 pro**             | **Seedance 1.0 pro fast**             |
| ----------------------- | ---------------------------- | --------------------------------- | -------------------------------- | -------------------------------- | ------------------------------------- |
...
| **样片模式(Draft)**     | -                            | -                                 | ✅                               | -                                | -                                     |
| **返回视频尾帧**        | ✅                           | ✅                                | ✅                               | ✅                               | ✅                                    |
| **输出分辨率**          | 480p, 720p                   | 480p, 720p                        | 480p, 720p, 1080p                | 480p, 720p, 1080p                | 480p, 720p, 1080p                     |
| **输出时长(秒)**        | 4~15                         | 4~15                              | 4~12                             | 2~12                             | 2~12                                  |
| **在线推理 RPM**        | 600                          | 600                               | 600                              | 600                              | 600                                   |
| **并发数**              | 10                           | 10                                | 10                               | 10                               | 10                                    |
| **离线推理(Flex)**      | -                            | -                                 | ✅ (5000亿 TPD)                  | ✅ (5000亿 TPD)                  | ✅ (5000亿 TPD)                       |

_(注：✅ 表示支持，- 表示不支持或功能未开放；Seedance 1.0 Lite 系列已按火山方舟公告下线，不再作为插件预设。)_
...
create_result = client.content_generation.tasks.create(
    # 注意：需选择支持该功能的模型，例如 Seedance 2.0
    model="doubao-seedance-2-0-260128",
    content=content,
    ratio="16:9",
    duration=5
